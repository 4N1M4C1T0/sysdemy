@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('SYSDEMY')])

@section('content')
    <div class="container" style="height: auto;">
        <div class="row align-items-center">
            <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
                <h3>{{ __('UNETE A LA MEJOR COMUNIDAD DE COMPRA Y VENTA DE CURSOS') }} </h3>
            </div>
                ...
                <form class="form" method="POST" action="{{ route('login') }}">
                  ...
                  <span class="input-group-text">
                    <i class="material-icons">face</i>
                                    ...
                                    <input type="text" name="username" class="form-control" placeholder="{{ __('Email or username...') }}" value="{{ old('username',null) }}" required autocomplete="username" autofocus>
                                </div>
